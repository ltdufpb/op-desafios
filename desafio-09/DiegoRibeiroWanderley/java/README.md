...
1. Transforma o valor na base de entrada para um n�mero decimal, multiplicando o valor da casa pelo número da base elevado a posição da casa
...
2. Rode no terminal:
```bash
$ java MeuPrograma.java base_entrada base_saida valor_base_entrada
```
