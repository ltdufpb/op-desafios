...
1. Começa um laço em ```posicoes.size()```, posicoes é a lista com os bytes do começo de cada linha, até 0
...
3. Rode no terminal:
```bash
$ java desafio3.MeuPrograma.java nome_arquivo.txt
```
# Saída

Ao executar o programa você verá as linhas do texto escritas de forma reversa
